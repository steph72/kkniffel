...
#define cg_vlinexy(x,y0,y1)   cg_vlinexy_raw(x, y0, y1, 5)
#define cg_hlinexy(x0,y,x1)   cg_hlinexy_raw(x0, y, x1, 0)
...
void cg_plotPetsciiChar(byte x, byte y, byte c, byte exAttr);
void cg_test();
